...
function PublicSources() {
  return (
    <section className="mt-[100px] pt-[100px] container mx-auto flex flex-col items-center">
      <h2 className="text-[64px] mb-11">Ommabop resurslar</h2>
      ...
      */}
      <div className="w-full items-center flex gap-5 mt-8">
